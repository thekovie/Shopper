...
>(({ className, placeholderClassName, ...props }, ref) => {
  ...
  return (
    <View className="flex flex-row overflow-hidden">
        ...
        />
        <TouchableOpacity className="flex items-center justify-center p-[8] native:h-12 h-10 border border-[#D3D3D3] rounded-md rounded-l-none ">
